...
import ResCard from "../RestaurantComponents/ResCard";
import restaurants from "../../assests/restaurant";
...
const Restaurant = () => {
  ...
  return (
    <div className="container restaurant">
      <h1 className="text-2xl font-bold  md:m-4">Restaurants List</h1>
      ...
      <div className="flex justify-between items-center mt-4 mb-4">
        <input
          ...
          className="border-black border-2 rounded px-2 md:m-4"
        />
      ...
      <div className="text-center m-2 p-2">
        <button
          ...
          className="m-2 bg-green-600 hover:bg-red-700 text-white font-bold py-
